...
with open('output/dendrogram-nocontext.pickle', 'rb') as f:
    Z = pickle.load(f)
labels = [
    'Walser',
    'Graubuenden',
...
with open('doc/figures/tfidf-nocontext-horizontal.tex', 'w') as f: # TODO
