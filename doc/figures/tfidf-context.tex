...
\node[corres] at (26) {a $>$ \textsubbar{a}\texthalflength};
\node[corres] at (28) {e $>$ y\textlengthmark};
\node[corres] at (29) {d $>$ t\textsuperscript{h}};
\node[corres] at (30) {e $>$ y\textlengthmark};
\node[corres] at (31) {t $>$ s};
\node[corres] at (32) {t $>$ t / S\_};
\node[corres] at (33) {t $>$ s};
\node[corres] at (34) {t $>$ t / \#\_};
\node[corres, right=6mm, above=0.3mm] at (35) {k $>$ k / \#\_};
\node[corres, right=6mm, above=0.5mm] at (36) {$\emptyset$ $>$ \textglotstop{} / \#\_};
\node[corres, left=5mm, above=0.3mm] at (37) {k $>$ k / \#\_};
% \node[corres] at (38) {};
