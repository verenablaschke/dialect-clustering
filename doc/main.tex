...
% 'N', 'cons', 'K', 'M', 'L', 'B', 'E', 'A', '#', 'W', 'S', 'H', 'J', 'vowel', 'Y', 'U', 'G', 'I', 'P', 'T', 'R'
...
% 430 correspondences >= the threshold (70% importance)
% 33 correspondences >= 90% importance
% 24 correspondences >= 95% importance
% 24 correspondences == 100% importance
...
Antwerp, Dutch Std BE, Ostend & k $>$ \textsubplus{k} & 100 & 100 & 100 & 13\\[2mm]

Biel, Cologne, Feer, Graubuenden, Hard, Herrlisheim, & t $>$ s & 90 & 82 & 100 & 59\\
Limburg, Luxembourg, Ortisei, Tuebingen, Walser &  t $>$ s / \_\#& 90 & 82 & 100 & 34\\[2mm]

Biel, Cologne, Feer, Graubuenden, Hard, Heligoland, & $\emptyset$ $>$ \textglotstop{} / \#\_ & 96 & 92 & 100 & 169\\
Herrlisheim, Limburg, Luxembourg, Ortisei, 
Tuebingen, Walser, Westerkwartier
