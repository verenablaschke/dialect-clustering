...
225 correspondences >= the threshold (80\% importance)
25 correspondences >= 90\% importance
19 correspondences >= 95\% importance
19 correspondences == 100\% importance

correspondences with 100\% importance:


\begin{table}[h]
\begin{tabular}{llrrrrc}
\hline
Cluster & Sound correspondence & Imp & Rep & Dist & Count & No context\\ \hline

Cologne, Luxembourg & x $>$ \textesh & 100 & 100 & 100 & 6 & x\\[2mm] % fɛ̝ʃ, fæʃt

Herrlisheim, Ortisei & a $>$ \textopeno & 100 & 100 & 100 & 10 & x\\
    & a $>$ \textopeno / \_cons & 100 & 100 & 100 & 10 \\[2mm] % kʰɔlt, kʰɔlt͡s
    
Heligoland, Westerkwartier & t $>$ \textsubring{d} & 100 & 100 & 100 & 8 & only nocontext \\[2mm]
...
Antwerp, Dutch Std BE, & f $>$ v & 100 & 100 & 100 & 15 & x\\
Ostend & k $>$ \textsubplus{k} & 100 & 100 & 100 & 13 & x\\
    & f $>$ v / \#\_ & 100 & 100 & 100 & 12\\[2mm]
    
Feer, Heligoland & d $>$ $\emptyset$ / cons\_ & 100 & 100 & 100 & 8\\[2mm]

Biel, Graubuenden, & e $>$ y\textlengthmark & 100 & 100 & 100 & 13 & x\\
Hard, Walser & & & & & \\[2mm]

Herrlisheim, Ortisei, Hard, & t $>$ s & 90 & 82 & 100 & 59 & only nocontext\\
Biel, Graubuenden, Walser, & & & & & \\
Limburg, Feer, Tuebingen, & & & & & \\
Cologne, Luxembourg & & & & & \\[2mm]
...
Heligoland, Westerkwartier, & $\emptyset$ $>$ \textglotstop{} & 96 & 92 & 100 & 169 & only nocontext\\
Herrlisheim, Ortisei, Hard, & s $>$ \textesh & 92 & 85 & 100 & 107 & only nocontext\\
Biel, Graubuenden, Walser, & & & & & \\
Limburg, Feer, Tuebingen, & & & & & \\
Cologne, Luxembourg & & & & & \\[2mm]
...
Grou, Dutch Std NL, Limburg, & k $>$ k / \#\_ & 100 & 100 & 100 & 40\\
Osten, Antweerp, Dutch Std BE, &  t $>$ t / \_\# & 100 & 100 & 100 & 37\\
Achterhoek, Veenkolonien & & & & &\\\hline
\end{tabular}
